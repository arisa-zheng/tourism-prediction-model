...
OUTPUT_DIR = "data/output/02_training_v2"
MODEL_DIR = "examples"
...
# =========================
def make_weighted_binary_crossentropy(pos_weight=2.5):
    def loss(y_true, y_pred):
...
# compile_model_with_custom_loss(model, custom_loss, optimizer=optimizer)
# print("Using Adam learning_rate =", optimizer.learning_rate.numpy())
...
# # =========================
# # HANDLE CLASS IMBALANCE (class_weight)
# # =========================
# print("\nSTEP 4.5: COMPUTE CLASS WEIGHTS")
